...
<div class="titulo-train-form col-12 pl-0 pr-0 ">Detox emocional, "Superando al Ex"</div> 
        ...
        <div class="row">
            ...
            <select class="custom-select video-list rounded-0" id="video-list" size="8">
              ...
              <option class="video-opt" value="1" selected > Día 1</option>
              <option class="video-opt video-par" value="2"> Día 2</option>
              <option class="video-opt" value="3"> Día 3</option>
              <option class="video-opt video-par" value="4"> Día 4</option>
              <option class="video-opt" value="5">Dia 5</option>
              <option class="video-opt video-par" value="6"> Día 6</option>
              <option class="video-opt" value="7">Dia 7</option>
              <option class="video-opt video-par" value="8"> Día 8</option>
              <option class="video-opt" value="9">Dia 9</option>
              <option class="video-opt video-par" value="10"> Día 10</option>
              <option class="video-opt" value="11">Dia 11</option>
              <option class="video-opt video-par" value="12"> Día 12</option>
              <option class="video-opt" value="13">Dia 13</option>
              <option class="video-opt video-par" value="14"> Día 14</option>
              <option class="video-opt" value="15">Dia 15</option>
              <option class="video-opt video-par" value="15"> Día 16</option>
            </select>
  </div> </div> 
    </div>
      </div>
        ...
        <p class="recursos-text col-6"> Recursos </p>
              <div class=" col-3"></div>
                <button class="btn v-tomarnota-btn col-3 rounded-0" id="btn-tomarnota" type="input" href="#">
                    Tomar nota
                 </button>
              </div>
        <br>
